...
def distorted_inputs(job_name, task_id, batch_size=FLAGS.batch_size):
...
#  print ('global batch_size: %d' % batch_size)
  ...
  return cifar10_input.distorted_inputs(job_name=job_name, task_id=task_id, data_dir=data_dir,
